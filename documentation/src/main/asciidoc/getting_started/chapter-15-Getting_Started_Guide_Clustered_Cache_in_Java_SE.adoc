...
[[sid-8093990_GettingStartedGuide-ClusteredCacheinJavaSE-RunningInfinispaninacluster]]
...
[[sid-8093990_GettingStartedGuide-ClusteredCacheinJavaSE-clusteredcachequickstartarchitecture]]
...
==== 
 ...
 The replication mode example contains two nodes, each of which are started in a separate process. The nodes are very simple, Node0 starts up, registers a listener that logs any changes, and waits for the cluster to form. Node1 starts up, waits for the cluster to form, and then adds an entry. The interesting work happens in the common super class, examined in <<sid-8093990_GettingStartedGuide-ClusteredCacheinJavaSE-Configuringareplicateddatagrid,Configuring a replicated data-grid>> . 
...
[[sid-8093990_GettingStartedGuide-ClusteredCacheinJavaSE-Tweakingtheclusterconfigurationforyournetwork]]
...
==== 
[[sid-8093990_GettingStartedGuide-ClusteredCacheinJavaSE-Configuringareplicateddatagrid]]
...
[[sid-8093990_GettingStartedGuide-ClusteredCacheinJavaSE-Configuringadistributeddatagrid]]
