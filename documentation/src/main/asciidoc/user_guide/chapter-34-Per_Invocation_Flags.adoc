...
[[sid-18645161_Per-InvocationFlags-Examples]]
...
[[sid-18645161_Per-InvocationFlags-DecoratedCache]]
...
[[sid-18645161_Per-InvocationFlags-Suppressingreturnvaluesfromaput%28%29orremove%28%29]]
