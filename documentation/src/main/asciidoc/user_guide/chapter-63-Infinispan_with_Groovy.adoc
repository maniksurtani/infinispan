...
[[sid-8093982_InfinispanwithGroovy-Introductionx]]
...
* Java and Infinispan
 ...
 Download those and extract/install where you feel appropiate, depending on your operating system and personal preferences you willeither have installers or compressed distributions. You can read more about read installing Java and Infinispan in link:$$https://docs.jboss.org/author/pages/viewpage.action?pageId=3737054$$[Installing Infinispan for the tutorials] . 

[[sid-8093982_InfinispanwithGroovy-InstallingGroovy]]


==== Installing Groovy

You can use the installer or compressed file to install the Groovy Platform, I used the compressed file and decompressed at C:\Program Files\groovy\groovy-1.6.3. Once you have installed the Groovy Platform you should set some environment varibles:
...
[[sid-8093982_InfinispanwithGroovy-InstallingInfinispan]]
...
[[sid-8093982_InfinispanwithGroovy-Settingtheclasspath]]
...
[[sid-8093982_InfinispanwithGroovy-Loadingtheconfigurationfile]]
...
Start by open a groovy console by typing groovysh in a command shell or terminal. You should now have something similar to:
...
[[sid-8093982_InfinispanwithGroovy-Basiccacheconfiguration]]
...
Thats all you have to add to the configuration file to have a simple named cache, now its time to interact with the cache by using the Infinispan API. Lets start by getting the named cache and put some objects inside it.
...
[[sid-8093982_InfinispanwithGroovy-Cachewithtransactionmanagement]]
...
[[sid-8093982_InfinispanwithGroovy-Cachewithacachestore]]
...
[[sid-8093982_InfinispanwithGroovy-Cachewitheviction]]
...
[[sid-8093982_InfinispanwithGroovy-Cachewithevictionandcachestore]]
...
[[sid-8093982_InfinispanwithGroovy-CachewithREPLSYNC%26transactionmanagement]]
